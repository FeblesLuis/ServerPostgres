using ApiMS.Application.Handlers.Queries.Usuarios;
...
{
    public class AgregarOperarioHandler : IRequestHandler<BuscarUsuarioIdQuery, BuscarUsuarioResponse>
    {
        private readonly ApiDbContext _dbContext;
        private readonly ILogger<AgregarOperarioHandler> _logger;
        public AgregarOperarioHandler(ApiDbContext dbContext, ILogger<AgregarOperarioHandler> logger)
        {
